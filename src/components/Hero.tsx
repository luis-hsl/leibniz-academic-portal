      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mb-6 md:mb-8 bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-white/20">
            <h2 className="text-xl md:text-2xl font-bold text-yellow-300 mb-3 font-montserrat">Reconhecimento e Excelência</h2>
          ...
          <div className="mb-8 md:mb-12">
            <p className="text-lg md:text-xl font-semibold text-yellow-300 font-montserrat">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center mb-12 md:mb-16 px-4 sm:px-6 lg:px-0">
            <Button onClick={openWhatsAppVisit} size="lg" className="bg-red-600 hover:bg-red-700 text-white text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 hover-scale w-full sm:w-auto min-h-[56px] font-montserrat font-semibold">
              Agende uma Visita
            </Button>
            <Button onClick={openWhatsApp} variant="outline" size="lg" className="border-2 border-white bg-white text-black hover:bg-gray-100 hover:text-black text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 w-full sm:w-auto min-h-[56px] font-montserrat font-semibold">
