      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 font-montserrat" style={{ color: '#fec10e' }}>
              Mapa do Site
            </h4>
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm font-montserrat">
              <div className="flex items-start justify-center sm:justify-start space-x-2 py-1">
                <MapPin className="h-3 w-3 sm:h-4 sm:w-4 mt-1 flex-shrink-0" style={{ color: '#fec10e' }} />
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-2 py-1 min-h-[44px] touch-target">
                <Phone className="h-3 w-3 sm:h-4 sm:w-4" style={{ color: '#fec10e' }} />
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-2 py-1 min-h-[44px] touch-target">
                <Mail className="h-3 w-3 sm:h-4 sm:w-4" style={{ color: '#fec10e' }} />
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex space-x-2 sm:space-x-3 mb-4 sm:mb-6 justify-center sm:justify-start">
              <a 
                ...
                className="p-2 sm:p-3 rounded-full hover:bg-white/10 transition-all duration-300 hover:scale-110 min-h-[44px] min-w-[44px] flex items-center justify-center touch-target"
                style={{ backgroundColor: '#fec10e' }}
                aria-label="Facebook do Colégio Leibniz"
              >
                <Facebook className="h-4 w-4 sm:h-5 sm:w-5" style={{ color: '#003366' }} />
              </a>
              <a 
              ...
              >
                <Instagram className="h-4 w-4 sm:h-5 sm:w-5" style={{ color: '#003366' }} />
              </a>
              <a 
                href="#" 
                className="p-2 sm:p-3 rounded-full hover:bg-white/10 transition-all duration-300 hover:scale-110 min-h-[44px] min-w-[44px] flex items-center justify-center touch-target"
              ...
              >
                <Youtube className="h-4 w-4 sm:h-5 sm:w-5" style={{ color: '#003366' }} />
              </a>
            </div>
