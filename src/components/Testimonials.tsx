              ...
              {studentImages.map((student, index) => (
                <CarouselItem key={index} className="pl-1 sm:pl-2 md:pl-4 lg:pl-6 basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/4">
                  <div className="p-1 sm:p-2 md:p-3">
                    <div className="relative overflow-hidden rounded-lg shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 animate-slide-up group"
